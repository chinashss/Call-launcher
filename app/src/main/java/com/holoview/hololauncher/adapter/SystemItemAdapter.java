 ...
 */
public class SystemItemAdapter extends RecyclerView.Adapter<SystemItemAdapter.ViewHolder> {
    private List<LauncherApp> launcherApps = new ArrayList<>();
    private Context mContext;
    private OnSystemItemClickLister mOnOptionItemClickLister;
    private static final String TAG = SystemItemAdapter.class.getSimpleName();

    public interface OnSystemItemClickLister {
        void onSystemItemClick(int position);
    }

    public SystemItemAdapter(Context context, List<LauncherApp> launcherApps) {
        super();
        mContext = context;
    ...
    public void setOnSystemItemClickLister(OnSystemItemClickLister onOptionItemClickLister) {
        this.mOnOptionItemClickLister = onOptionItemClickLister;
    }

    @Override
    public ViewHolder onCreateViewHolder(ViewGroup viewGroup, int i) {
        View view = LayoutInflater.from(mContext).inflate(R.layout.item_system_apps, viewGroup, false);
        ...
        viewHolder.itemView.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if (mOnOptionItemClickLister != null) {
                    mOnOptionItemClickLister.onSystemItemClick(position);
                }
            }
        });
    ...
    public class ViewHolder extends RecyclerView.ViewHolder {
        ...
        public ViewHolder(View itemView) {
            super(itemView);
            mImageView = itemView.findViewById(R.id.iv_system_apps_logo);
            mTextView = itemView.findViewById(R.id.tv_system_apps_name);
        }
    }
